    ...
    return (
        <div className="w-full h-screen flex items-center justify-center p-3">
            <div className="max-w-[320px] border w-full md:min-w-[380px] xl:w-[30vw] overflow-hidden rounded-2xl shadow-xl">
                <div className="w-full rounded-t-2xl bg-[#2E5077] text-center text-white h-[120px] border">
                ...
                <div className=" p-4 md:p-6 lg:p-8">
                    ...
                    <div>
                        <p className="text-end text-sm  text-neutral-400">Forgot &nbsp;  <strong className="cursor-pointer text-[#2E5077]">Username</strong> / <strong className="cursor-pointer text-[#2E5077]">Password</strong> </p>
                    </div>
                    ...
                    <div className="mt-20 mb-6 lg:mt-20 flex flex-col justify-center items-center">
                        ...
                        <Link className="uppercase mt-2 transition-all text-[#2E5077] font-semibold " to={"/signup"}>Sign up now</Link>
                    </div>
                </div>
            </div>
